...
#SBATCH --job-name=pgolf-train-16x
...
export RUN_ID="${RUN_ID:-${SCRIPT_BASENAME}_16x}"

# 16 GPUs = 2x the canonical setup, double batch tokens to keep grad accum reasonable
export MAX_WALLCLOCK_SECONDS="${MAX_WALLCLOCK_SECONDS:-600}"
export TRAIN_BATCH_TOKENS="${TRAIN_BATCH_TOKENS:-1572864}"
...
#  TRAIN_SCRIPT=train_gpt_pe_r2.py TRAIN_BATCH_TOKENS=1572864 sbatch scripts/train_16xA100.sh
